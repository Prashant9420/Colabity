    ...
    <div className="flex justify-end bg-base-100">
      ...
      <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          <h3 className="font-bold text-lg">Select a File to Open</h3>
          {codeFiles.map((file:any,index:any) => (
            <div className="flex justify-between items-center"><p className={`pl-4 pt-2 pb-2 mt-2 mr-2 rounded-60 w-full ${(currentFileIndex===index)?"bg-accent text-base-100":"hover:bg-neutral"} `} onClick={()=>{setCurrentFileIndex(index)}}>{file.filename}</p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 cursor-pointer">
